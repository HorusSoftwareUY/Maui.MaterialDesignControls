...
public class AppiumSetup
{
	...
	public void RunBeforeAnyTests()
	{
		...
		var macOptions = new AppiumOptions
		{
			...
			App = "../../samples/HorusStudio.Maui.MaterialDesignControls.Sample/bin/Debug/net9.0-maccatalyst/maccatalyst-x64/HorusStudio.Maui.MaterialDesignControls.Sample.app"
		};

		// Setting the Bundle ID is required, else the automation will run on Finder
		macOptions.AddAdditionalAppiumOption(IOSMobileCapabilityType.BundleId, "com.horusstudio.maui.materialdesigncontrols.sample");
