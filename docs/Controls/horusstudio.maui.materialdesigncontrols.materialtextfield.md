...
Text fields let users enter text into a UI and follow Material Design Guidelines. [See more](https://m3.material.io/components/text-fields/overview).
...
Internal implementation of the Entry control.
...
Default value: ReturnType.Default
