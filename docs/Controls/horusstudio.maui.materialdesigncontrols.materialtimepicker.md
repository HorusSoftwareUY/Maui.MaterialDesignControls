...
Time pickers let users select a time. They typically appear in forms and dialogs and, partially, follow Material Design Guidelines. [See more.](https://m3.material.io/components/time-pickers/overview)
...
Internal implementation of the TimePicker control.
...
Gets or sets the displayed time. This is a bindable property.
            ...
            The TimeSpan displayed in the TimePicker.
