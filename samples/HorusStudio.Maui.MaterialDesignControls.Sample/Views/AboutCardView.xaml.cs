...
public partial class AboutCardView : ContentView
{
    ...
    public static readonly BindableProperty FirstIconSourceProperty =
           BindableProperty.Create(nameof(FirstIconSource), typeof(string), typeof(AboutCardView), default(string));

    public static readonly BindableProperty SecondIconSourceProperty =
           BindableProperty.Create(nameof(SecondIconSource), typeof(string), typeof(AboutCardView), default(string));

    public static readonly BindableProperty TitleProperty =
        BindableProperty.Create(nameof(Title), typeof(string), typeof(AboutCardView), default(string));

    public static readonly BindableProperty DescriptionProperty =
        BindableProperty.Create(nameof(Description), typeof(string), typeof(AboutCardView), default(string));    

    public static readonly BindableProperty TextButtonProperty =
       BindableProperty.Create(nameof(TextButton), typeof(string), typeof(AboutCardView), default(string));

    public static readonly BindableProperty TypeButtonProperty =
       BindableProperty.Create(nameof(TypeButton), typeof(MaterialButtonType), typeof(AboutCardView), default(MaterialButtonType));

    public static readonly BindableProperty CommandProperty =
        BindableProperty.Create(nameof(Command), typeof(ICommand), typeof(AboutCardView), default(ICommand));

    public static readonly BindableProperty CommandParameterProperty =
      BindableProperty.Create(nameof(CommandParameter), typeof(string), typeof(AboutCardView), default(string));
