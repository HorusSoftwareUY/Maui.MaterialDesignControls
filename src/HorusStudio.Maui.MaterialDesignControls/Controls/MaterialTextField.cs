...
/// <summary>
/// A button <see cref="View" /> that reacts to touch events and follows Material Design Guidelines <see href="https://m3.material.io/components/text-fields/overview">.
/// </summary>
public class MaterialTextField : ContentView, ITouchAndPressBehaviorConsumer
{
    #region Attributes

    private readonly static MaterialTextFieldType DefaultButtonType = MaterialTextFieldType.Filled;
    ...
    private readonly Dictionary<MaterialTextFieldType, object> _backgroundColors = new()
    {
        { MaterialTextFieldType.Filled, new AppThemeBindingExtension { Light = MaterialLightTheme.Primary, Dark = MaterialDarkTheme.Primary } }
    };

    private readonly Dictionary<MaterialTextFieldType, object> _textColors = new()
    {
        { MaterialTextFieldType.Filled, new AppThemeBindingExtension { Light = MaterialLightTheme.OnPrimary, Dark = MaterialDarkTheme.OnPrimary } },
        { MaterialTextFieldType.Outlined, new AppThemeBindingExtension { Light = MaterialLightTheme.Primary, Dark = MaterialDarkTheme.Primary } }
    };

    private readonly Dictionary<MaterialTextFieldType, Shadow> _shadows = new()
    {
    };

    private readonly Dictionary<MaterialTextFieldType, object> _borderColors = new()
    {
        { MaterialTextFieldType.Outlined, new AppThemeBindingExtension { Light = MaterialLightTheme.Outline, Dark = MaterialDarkTheme.Outline } },
    };

    private readonly Dictionary<MaterialTextFieldType, double> _borderWidths = new()
    {
        { MaterialTextFieldType.Outlined, 1 }
    };
    ...
    /// </summary>
    public static readonly BindableProperty TypeProperty = BindableProperty.Create(nameof(Type), typeof(MaterialTextFieldType), typeof(MaterialTextField), defaultValue: DefaultButtonType, propertyChanged: (bindable, oldValue, newValue) =>
    {
        if (bindable is MaterialTextField self)
        {
            if (Enum.IsDefined(typeof(MaterialTextFieldType), oldValue) &&
                Enum.IsDefined(typeof(MaterialTextFieldType), newValue) &&
                (MaterialTextFieldType)oldValue != (MaterialTextFieldType)newValue)
            {
                self.UpdateLayoutAfterTypeChanged((MaterialTextFieldType)newValue);
            }
        }
    });
    ...
    /// </summary>
    public static readonly BindableProperty CommandProperty = BindableProperty.Create(nameof(Command), typeof(ICommand), typeof(MaterialTextField));

    /// <summary>
    /// The backing store for the <see cref="CommandParameter" /> bindable property.
    /// </summary>
    public static readonly BindableProperty CommandParameterProperty = BindableProperty.Create(nameof(CommandParameter), typeof(object), typeof(MaterialTextField));

    /// <summary>
    /// The backing store for the <see cref="ContentLayout" /> bindable property.
    /// </summary>
    public static readonly BindableProperty ContentLayoutProperty = BindableProperty.Create(nameof(ContentLayout), typeof(ButtonContentLayout), typeof(MaterialTextField), defaultValue: DefaultContentLayout, propertyChanged: (bindable, oldValue, newValue) =>
    {
        if (bindable is MaterialTextField self)
        {
    ...
    /// </summary>
    public static readonly BindableProperty TextProperty = BindableProperty.Create(nameof(Text), typeof(string), typeof(MaterialTextField));

    /// <summary>
    /// The backing store for the <see cref="TextColor" /> bindable property.
    /// </summary>
    public static readonly BindableProperty TextColorProperty = BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(MaterialTextField), defaultValue: DefaultTextColor, propertyChanged: (bindable, o, n) =>
    {
        if (bindable is MaterialTextField self)
        {
    ...
    /// </summary>
    public static readonly BindableProperty IconTintColorProperty = BindableProperty.Create(nameof(IconTintColor), typeof(Color), typeof(MaterialTextField), defaultValue: DefaultTintColor, propertyChanged: (bindable, o, n) =>
    {
        if (bindable is MaterialTextField self)
        {
    ...
    /// </summary>
    internal static readonly BindableProperty TintColorProperty = BindableProperty.Create(nameof(TintColor), typeof(Color), typeof(MaterialTextField), defaultValue: DefaultTintColor);

    /// <summary>
    /// The backing store for the <see cref="CharacterSpacing" /> bindable property.
    /// </summary>
    public static readonly BindableProperty CharacterSpacingProperty = BindableProperty.Create(nameof(CharacterSpacing), typeof(double), typeof(MaterialTextField), Button.CharacterSpacingProperty.DefaultValue);

    /// <summary>
    /// The backing store for the <see cref="FontFamily" /> bindable property.
    /// </summary>
    public static readonly BindableProperty FontFamilyProperty = BindableProperty.Create(nameof(FontFamily), typeof(string), typeof(MaterialTextField), defaultValue: DefaultFontFamily);

    /// <summary>
    /// The backing store for the <see cref="FontSize" /> bindable property.
    /// </summary>
    public static readonly BindableProperty FontSizeProperty = BindableProperty.Create(nameof(FontSize), typeof(double), typeof(MaterialTextField), defaultValue: DefaultFontSize);

    /// <summary>
    /// The backing store for the <see cref="TextTransform" /> bindable property.
    /// </summary>
    public static readonly BindableProperty TextTransformProperty = BindableProperty.Create(nameof(TextTransform), typeof(TextTransform), typeof(MaterialTextField), defaultValue: Button.TextTransformProperty.DefaultValue);

    /// <summary>
    /// The backing store for the <see cref="FontAttributes" /> bindable property.
    /// </summary>
    public static readonly BindableProperty FontAttributesProperty = BindableProperty.Create(nameof(FontAttributes), typeof(FontAttributes), typeof(MaterialTextField), defaultValue: Button.FontAttributesProperty.DefaultValue);

    /// <summary>
    /// The backing store for the <see cref="FontAutoScalingEnabled" /> bindable property.
    /// </summary>
    public static readonly BindableProperty FontAutoScalingEnabledProperty = BindableProperty.Create(nameof(FontAutoScalingEnabled), typeof(bool), typeof(MaterialTextField), defaultValue: Button.FontAutoScalingEnabledProperty.DefaultValue);

    /// <summary>
    /// The backing store for the <see cref="Background" /> bindable property.
    /// </summary>
    public static new readonly BindableProperty BackgroundProperty = BindableProperty.Create(nameof(Background), typeof(Brush), typeof(MaterialTextField), defaultValue: DefaultBackground, propertyChanged: (bindable, o, n) =>
    {
        if (bindable is MaterialTextField self)
        {
    ...
    /// </summary>
    public static new readonly BindableProperty BackgroundColorProperty = BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(MaterialTextField), defaultValue: DefaultBackgroundColor, propertyChanged: (bindable, o, n) =>
    {
        if (bindable is MaterialTextField self)
        {
    ...
    /// </summary>
    public static readonly BindableProperty BorderWidthProperty = BindableProperty.Create(nameof(BorderWidth), typeof(double), typeof(MaterialTextField), defaultValue: DefaultBorderWidth, propertyChanged: (bindable, o, n) =>
    {
        if (bindable is MaterialTextField self)
        {
    ...
    /// </summary>
    public static readonly BindableProperty BorderColorProperty = BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(MaterialTextField), defaultValue: DefaultBorderColor, propertyChanged: (bindable, o, n) =>
    {
        if (bindable is MaterialTextField self)
        {
    ...
    /// </summary>
    public static readonly BindableProperty CornerRadiusProperty = BindableProperty.Create(nameof(CornerRadius), typeof(int), typeof(MaterialTextField), defaultValue: DefaultCornerRadius);

    /// <summary>
    /// The backing store for the <see cref="ImageSource" /> bindable property.
    /// </summary>
    public static readonly BindableProperty ImageSourceProperty = BindableProperty.Create(nameof(ImageSource), typeof(ImageSource), typeof(MaterialTextField), propertyChanged: (bindable, oldValue, newValue) =>
    {
        if (bindable is MaterialTextField self)
        {
            if ((newValue == null && oldValue != null) ||
    ...
    /// </summary>
    public static new readonly BindableProperty PaddingProperty = BindableProperty.Create(nameof(Padding), typeof(Thickness), typeof(MaterialTextField), defaultValue: DefaultPadding, propertyChanged: (bindable, oldValue, newValue) =>
    {
        if (bindable is MaterialTextField self)
        {
            self.UpdatePadding();
    ...
    /// </summary>
    public static readonly BindableProperty LineBreakModeProperty = BindableProperty.Create(nameof(LineBreakMode), typeof(LineBreakMode), typeof(MaterialTextField), defaultValue: Button.LineBreakModeProperty.DefaultValue);

    /// <summary>
    /// The backing store for the <see cref="Animation"/> bindable property.
    /// </summary>
    public static readonly BindableProperty AnimationProperty = BindableProperty.Create(nameof(Animation), typeof(AnimationTypes), typeof(MaterialTextField), defaultValue: DefaultAnimationType);

    /// <summary>
    /// The backing store for the <see cref="AnimationParameter"/> bindable property.
    /// </summary>
    public static readonly BindableProperty AnimationParameterProperty = BindableProperty.Create(nameof(AnimationParameter), typeof(double?), typeof(MaterialTextField), defaultValue: DefaultAnimationParameter);

    /// <summary>
    /// The backing store for the <see cref="CustomAnimation"/> bindable property.
    /// </summary>
    public static readonly BindableProperty CustomAnimationProperty = BindableProperty.Create(nameof(CustomAnimation), typeof(ICustomAnimation), typeof(MaterialTextField));

    /// <summary>
    /// The backing store for the <see cref="HeightRequest" /> bindable property.
    /// </summary>
    public static new readonly BindableProperty HeightRequestProperty = BindableProperty.Create(nameof(HeightRequest), typeof(double), typeof(MaterialTextField), defaultValue: DefaultHeightRequest);

    /// <summary>
    /// The backing store for the <see cref="IsBusy"/> bindable property.
    /// </summary>
    public static readonly BindableProperty IsBusyProperty = BindableProperty.Create(nameof(IsBusy), typeof(bool), typeof(MaterialTextField), defaultValue: false, propertyChanged: (bindable, _, newValue) =>
    {
        if (bindable is MaterialTextField self)
        {
    ...
    /// </summary>
    public static readonly BindableProperty BusyIndicatorColorProperty = BindableProperty.Create(nameof(BusyIndicatorColor), typeof(Color), typeof(MaterialTextField), defaultValue: DefaultBusyIndicatorColor);

    /// <summary>
    /// The backing store for the <see cref="BusyIndicatorSize"/> bindable property.
    /// </summary>
    public static readonly BindableProperty BusyIndicatorSizeProperty = BindableProperty.Create(nameof(BusyIndicatorSize), typeof(double), typeof(MaterialTextField), defaultValue: DefaultBusyIndicatorSize);

    /// <summary>
    /// The backing store for the <see cref="CustomBusyIndicator"/> bindable property.
    /// </summary>
    public static readonly BindableProperty CustomBusyIndicatorProperty = BindableProperty.Create(nameof(CustomBusyIndicator), typeof(View), typeof(MaterialTextField), propertyChanged: (bindable, _, newValue) =>
    {
        if (bindable is MaterialTextField self)
        {
    ...
    /// </summary>
    public static new readonly BindableProperty ShadowProperty = BindableProperty.Create(nameof(Shadow), typeof(Shadow), typeof(MaterialTextField), defaultValue: DefaultShadow, propertyChanged: (bindable, o, n) =>
    {
        if (bindable is MaterialTextField self)
        {
    ...
    /// <summary>
    /// Gets or sets the button type according to <see cref="MaterialTextFieldType"/> enum.
    /// The default value is <see cref="MaterialTextFieldType.Filled"/>. This is a bindable property.
    /// </summary>
    public MaterialTextFieldType Type
    {
        get => (MaterialTextFieldType)GetValue(TypeProperty);
    ...
    private void UpdateLayoutAfterTypeChanged(MaterialTextFieldType type)
    {
        SetBackground(type);
    ...
    private void SetBackground(MaterialTextFieldType type)
    {
    ...
    private void SetBackgroundColor(MaterialTextFieldType type)
    {
        if (_backgroundColors.TryGetValue(type, out object background) && background != null)
        {
    ...
    private void SetTextColor(MaterialTextFieldType type)
    {
    ...
    private void SetTintColor(MaterialTextFieldType type)
    {
    ...
    private void SetBorderColor(MaterialTextFieldType type)
    {
    ...
    private void SetBorderWidth(MaterialTextFieldType type)
    {
    ...
    private void SetShadow(MaterialTextFieldType type)
    {
