...
namespace HorusStudio.Maui.MaterialDesignControls
{
    ...
    public class MaterialButton : Grid, ITouchAndPressBehaviorConsumer
    {
        ...
        public static readonly BindableProperty TextColorProperty =
            BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(MaterialButton), defaultValue: ColorUtil.DefaultColor);
        ...
        public static readonly BindableProperty DisabledTextColorProperty =
            BindableProperty.Create(nameof(DisabledTextColor), typeof(Color), typeof(MaterialButton), defaultValue: ColorUtil.DefaultColor);
        ...
        public static readonly new BindableProperty BackgroundColorProperty =
            BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(MaterialButton), defaultValue: ColorUtil.DefaultColor);
        ...
        public static readonly BindableProperty DisabledBackgroundColorProperty =
            BindableProperty.Create(nameof(DisabledBackgroundColor), typeof(Color), typeof(MaterialButton), defaultValue: ColorUtil.DefaultColor);
        ...
        public static readonly BindableProperty BorderColorProperty =
            BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(MaterialButton), defaultValue: ColorUtil.DefaultColor);
        ...
        public static readonly BindableProperty DisabledBorderColorProperty =
            BindableProperty.Create(nameof(DisabledBorderColor), typeof(Color), typeof(MaterialButton), defaultValue: ColorUtil.DefaultColor);
        ...
        public void SetButtonType()
        {
            switch (ButtonType)
            {
                case MaterialButtonType.Elevated:
                    _textLabel.TextColor = IsEnabled ? (TextColor != ColorUtil.DefaultColor ? TextColor : MaterialColor.Primary) : (DisabledTextColor != ColorUtil.DefaultColor ? DisabledTextColor : MaterialColor.Disable);
                    _frameLayout.BackgroundColor = BackgroundColor != ColorUtil.DefaultColor ? BackgroundColor : MaterialColor.OnPrimary;
                    _frameLayout.BorderColor = BackgroundColor != ColorUtil.DefaultColor ? BackgroundColor : MaterialColor.OnPrimary;
                    _frameLayout.HasShadow = true;
                    break;
                case MaterialButtonType.Filled:
                    _textLabel.TextColor = IsEnabled ? (TextColor != ColorUtil.DefaultColor ? TextColor : MaterialColor.OnPrimary) : (DisabledTextColor != ColorUtil.DefaultColor ? DisabledTextColor : MaterialColor.OnPrimary);
                    _frameLayout.BackgroundColor = IsEnabled ? (BackgroundColor != ColorUtil.DefaultColor ? BackgroundColor : MaterialColor.Primary) : (DisabledBackgroundColor != ColorUtil.DefaultColor ? DisabledBackgroundColor : MaterialColor.Disable);
                    _frameLayout.BorderColor = Colors.Transparent;
                    _frameLayout.HasShadow = false;
                    break;
                case MaterialButtonType.Tonal:
                    _textLabel.TextColor = IsEnabled ? (TextColor != ColorUtil.DefaultColor ? TextColor : MaterialColor.Primary) : (DisabledTextColor != ColorUtil.DefaultColor ? DisabledTextColor : MaterialColor.Disable);
                    var defaultBackgroundColor = Color.FromRgba(MaterialColor.Primary.Red, MaterialColor.Primary.Green, MaterialColor.Primary.Blue, 0.4);
                    _frameLayout.BackgroundColor = IsEnabled ? defaultBackgroundColor : (DisabledBackgroundColor != ColorUtil.DefaultColor ? DisabledBackgroundColor : MaterialColor.Disable);
                    _frameLayout.BorderColor = Colors.Transparent;
                    _frameLayout.HasShadow = false;
                    break;
                case MaterialButtonType.Outlined:
                    _textLabel.TextColor = IsEnabled ? (TextColor != ColorUtil.DefaultColor ? TextColor : MaterialColor.Primary) : (DisabledTextColor != ColorUtil.DefaultColor ? DisabledTextColor : MaterialColor.Disable);
                    _frameLayout.BackgroundColor = BackgroundColor != ColorUtil.DefaultColor ? BackgroundColor : MaterialColor.OnPrimary;
                    _frameLayout.BorderColor = IsEnabled ? (BorderColor != ColorUtil.DefaultColor ? BorderColor : MaterialColor.Primary) : (DisabledBorderColor != ColorUtil.DefaultColor ? DisabledBorderColor : MaterialColor.Disable);
                    _frameLayout.HasShadow = false;
                    break;
