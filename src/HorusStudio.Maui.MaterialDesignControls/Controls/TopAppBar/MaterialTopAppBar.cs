...
namespace HorusStudio.Maui.MaterialDesignControls.Controls.TopAppBar
{
...
#nullable disable
        ...
        private readonly static Color DefaultBusyColor = new AppThemeBindingExtension { Light = MaterialLightTheme.Primary, Dark = MaterialDarkTheme.Primary }.GetValueForCurrentTheme<Color>();
        ...
        /// </summary>
        public static readonly BindableProperty TypeProperty = BindableProperty.Create(nameof(Type), typeof(MaterialTopAppBarType), typeof(MaterialTopAppBar), DefaultType, BindingMode.OneTime);
        ...
        /// </summary>
        public static readonly BindableProperty DescriptionProperty = BindableProperty.Create(nameof(Description), typeof(string), typeof(MaterialTopAppBar), null, BindingMode.OneTime);
        ...
        /// </summary>
        public static readonly BindableProperty LeadingIconProperty = BindableProperty.Create(nameof(LeadingIcon), typeof(ImageSource), typeof(MaterialTopAppBar), defaultValue: null);

        /// <summary>
        /// The backing store for the <see cref="TrailingIcon" /> bindable property.
        /// </summary>
        public static readonly BindableProperty TrailingIconProperty = BindableProperty.Create(nameof(TrailingIcon), typeof(ImageSource), typeof(MaterialTopAppBar), defaultValue: null);
        ...
        /// </summary>
        public static readonly BindableProperty LeadingIconCommandProperty = BindableProperty.Create(nameof(LeadingIconCommand), typeof(ICommand), typeof(MaterialTopAppBar), null, BindingMode.OneTime);

        /// <summary>
        /// The backing store for the <see cref="TrailingIconCommand" /> bindable property.
        /// </summary>
        public static readonly BindableProperty TrailingIconCommandProperty = BindableProperty.Create(nameof(TrailingIconCommand), typeof(ICommand), typeof(MaterialTopAppBar), null, BindingMode.OneTime);
        ...
        /// </summary>
        public static readonly BindableProperty TrailingIconIsBusyProperty = BindableProperty.Create(nameof(TrailingIconIsBusy), typeof(bool), typeof(MaterialButton), defaultValue: false);

        /// <summary>
        /// The backing store for the <see cref="LeadingIconIsBusy" /> bindable property.
        /// </summary>
        public static readonly BindableProperty LeadingIconIsBusyProperty = BindableProperty.Create(nameof(LeadingIconIsBusy), typeof(bool), typeof(MaterialButton), defaultValue: false);

        /// <summary>
        /// The backing store for the <see cref="BusyColor" /> bindable property.
        /// </summary>
        public static readonly BindableProperty BusyColorProperty = BindableProperty.Create(nameof(BusyColor), typeof(Color), typeof(MaterialButton), defaultValue: DefaultBusyColor);
