namespace HorusStudio.Maui.MaterialDesignControls
{
    ...
    {
        public static Color Primary { get; set; } = Color.FromHex("#6750A4");

        public static Color OnPrimary { get; set; } = Color.FromHex("#FFFFFF");

        public static Color PrimaryContainer { get; set; } = Color.FromHex("#EADDFF");
